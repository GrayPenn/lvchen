...
<div>
			...
			<div class="templatemo-content-wrapper">
				...
				<input type="submit" id="" value="管理房源" />
				</form>
				<form action="TouploadroomServlet?name=${sessionScope.user.uname }" method="post" enctype="multipart/form-data">
				<input type="submit" id="" value="发布房源" />
				</form>
				</div>
			</div>
			</div>
