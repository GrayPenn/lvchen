...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $("a.edit").fancybox({
	        ...
	        'showCloseButton' : false,
	        'onClosed' : function() { 
	        	window.location.href = 'houseedit.jsp';
	        }
	    });
	});
	/** 用户角色   **/
	...
	/** 模糊查询来电用户  **/
	function search(){
		$("#submitForm").attr("action", "../HouseListServlet" ).submit();
	}
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<c:forEach items="${house}" var="h">
							<tr>
								...
								<td>${h.hid }</td>
								<td></td>
								<td><img alt="" src="admin/${h.hcei}"></td>
								<td>${h.haddr }</td>
								<td>${h.hlocation }</td>
								<td>${h.htype }</td>
								<td>公租房</td>
								...
								<td>
									<a href="admin/houseedit.jsp?hid=${h.hid }" class="edit">编辑</a> 
